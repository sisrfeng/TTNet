...
if __name__ == '__main__':
    ...
    train_video_filenames      =  ['game_{}.mp4'.format(i) for i in range(1, 6)]
    train_annotation_filenames =  ['game_{}.zip'.format(i) for i in range(1, 6)]

    test_video_filenames      =  ['test_{}.mp4'.format(i) for i in range(1, 8)]
    test_annotation_filenames =  ['test_{}.zip'.format(i) for i in range(1, 8)]
